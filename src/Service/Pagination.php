...
class Pagination {
    ...
    /**
     * Permet d'obtenir le contenu du date dans l'ordre décroissant
     *
     * @var string
     */
    private $orderData = 'desc';
    ...
    public function getData() {
        ...
        return $this->manager
            ->getRepository($this->entityClass)
            ->findBy([], ['id'=>$this->orderData], $this->limit, $offset);
    }
    /**
    ...
    /**
     * Permet de configuer l'odre si il est différent de celui par default
     *
    ...
    /**
     * Permet de recuper l'ordre des datas
     * @return string
     */
